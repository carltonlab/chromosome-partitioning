...
nruns=15000
corun=1500      # COs made after this run number
nsyps=4000
nplks=1200
...
ph_off=0.010     # phos-SYP off-rate (off if random value is lower)
np_off=0.010     # non-phos SYP off-rate (off if random value is lower)
...
sbs_mult=0.8    # modifier of SYP attractiveness for phosphorylated SBS
sbs_phos=0.7    # rate of SBS phosphorylation
sbs_deph=0.6    # rate of SBS dephosphorylation
...
with open("sypinfo.txt","w") as sypinfo_file:
    for r in syplist:
        print(r.gen,r.xs,r.pos,r.phos,r.plk,r.bindcount,r.phoscount,file=sypinfo_file)
